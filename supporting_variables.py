...
step_horizon = 0.3  # time between steps in seconds?? 0.1 Try diefferent step size.
...
obstacle_stationary_trajectory = [[15,10]]
...
m = 180      #Mass of USV
Iz = 446      #Value did not find in code gussed and set value
...
##########
lbx[0: n_states*(N+1): n_states] = -2000     # X lower bound
lbx[1: n_states*(N+1): n_states] = -2000     # Y lower bound
lbx[2: n_states*(N+1): n_states] = -2000     # theta lower bound
lbx[3: n_states*(N+1): n_states] = -3        # u lower bound
lbx[4: n_states*(N+1): n_states] = -3        # v lower bound
lbx[5: n_states*(N+1): n_states] = -1     # r lower bound

ubx[0: n_states*(N+1): n_states] = 2000      # X upper bound
ubx[1: n_states*(N+1): n_states] = 2000      # Y upper bound
ubx[2: n_states*(N+1): n_states] = 2000      # theta upper bound
ubx[3: n_states*(N+1): n_states] = 3         # u upper bound
ubx[4: n_states*(N+1): n_states] = 3        # v upper bound
ubx[5: n_states*(N+1): n_states] = 1      # r upper bound
